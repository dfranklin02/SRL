...
<button data-toggle="collapse" data-target="#timerec1" style="background-color:LightGreen; width:100%; font-size:20px"><b><i>Guiding Principle 1:</i> Start Studying/working several days in advance of due dates</b></button>
...
<button data-toggle="collapse" data-target="#timerec2" style="background-color:LightGreen; width:100%; font-size:20px"><b><i>Guiding Principle 2:</i> Set aside regular times using a weekly calendar</b></button>
...
<button data-toggle="collapse" data-target="#timerec3" style="background-color:LightGreen; width:100%; font-size:20px"><b><i>Guiding Principle 3:</i> Prioritize tasks</b></button>
...
<button data-toggle="collapse" data-target="#timerec4" style="background-color:LightGreen; width:100%; font-size:20px"><b><i>Guiding Principle 4:</i> Practice estimating the amount of time you need</b></button>
...
<button data-toggle="collapse" data-target="#timerec5" style="background-color:LightGreen; width:100%; font-size:20px"><b><i>Guiding Principle 5:</i> Set specific study goals</b></button>
...
<button data-toggle="collapse" data-target="#timerec6" style="background-color:LightGreen; width:100%; font-size:20px"><b><i>Guiding Principle 6:</i> Break up your study/work times into small chunks</b></button>
...
<button data-toggle="collapse" data-target="#timerec7" style="background-color:LightGreen; width:100%; font-size:20px"><b><i>Guiding Principle 7:</i> Take breaks while completing your school work</b></button>
...
<button data-toggle="collapse" data-target="#timerec8" style="background-color:LightGreen; width:100%; font-size:20px"><b><i>Guiding Principle 8: Alternate study topics/tasks</i></b></button>
...
<button data-toggle="collapse" data-target="#timerec9" style="background-color:LightGreen; width:100%; font-size:20px"><b><i>Guiding Principle 9:</i> Reduce procrastination</b></button>
...
<button data-toggle="collapse" data-target="#environmentrec1" style="background-color:Orange; width:100%; font-size:20px"><b><i>Guiding Principle 1:</i> Study in a quiet place with minimal distractions</b></button>
...
<button data-toggle="collapse" data-target="#environmentrec2" style="background-color:Orange; width:100%; font-size:20px"><b><i>Guiding Principle 2:</i> Inform others around you of “do not disturb” rules</b></button>
...
<button data-toggle="collapse" data-target="#environmentrec3" style="background-color:Orange; width:100%; font-size:20px"><b><i>Guiding Principle 3:</i> Minimize excess technology use</b></button>
...
<button data-toggle="collapse" data-target="#environmentrec4" style="background-color:Orange; width:100%; font-size:20px"><b><i>Guiding Principle 4:</i> Vary the places where you study</b></button>
...
<button data-toggle="collapse" data-target="#environmentrec5" style="background-color:Orange; width:100%; font-size:20px"><b><i>Guiding Principle 5:</i> Find the right balance of comfort in your environment</b></button>
...
<button data-toggle="collapse" data-target="#understandingrec1" style="background-color:CornflowerBlue; width:100%; font-size:20px"><b><i>Guiding Principle 1:</i> Quiz and test yourself</b></button>
...
<button data-toggle="collapse" data-target="#understandingrec2" style="background-color:CornflowerBlue; width:100%; font-size:20px"><b><i>Guiding Principle 2:</i> Spread out your studying over time</b></button>
...
<button data-toggle="collapse" data-target="#understandingrec3" style="background-color:CornflowerBlue; width:100%; font-size:20px"><b><i>Guiding Principle 3:</i> ELABORATE on material: Explain why something is true</b></button>
...
<button data-toggle="collapse" data-target="#understandingrec4" style="background-color:CornflowerBlue; width:100%; font-size:20px"><b><i>Guiding Principle 4:</i> ELABORATE on material: Relate new information to other ideas</b></button>
...
<button data-toggle="collapse" data-target="#understandingrec6" style="background-color:CornflowerBlue; width:100%; font-size:20px"><b><i>Guiding Principle 6:</i> Form mental images from text</b></button>
...
<button data-toggle="collapse" data-target="#understandingrec7" style="background-color:CornflowerBlue; width:100%; font-size:20px"><b><i>Guiding Principle 7:</i> Talk aloud while you are reading</b></button>
...
<button data-toggle="collapse" data-target="#understandingrec8" style="background-color:CornflowerBlue; width:100%; font-size:20px"><b><i>Guiding Principle 8:</i> Take and rewrite notes</b></button>
...
<button data-toggle="collapse" data-target="#understandingrec9" style="background-color:CornflowerBlue; width:100%; font-size:20px"><b><i>Guiding Principle 9:</i> Make flash cards</b></button>
...
<button data-toggle="collapse" data-target="#understandingrec10" style="background-color:CornflowerBlue; width:100%; font-size:20px"><b><i>Guiding Principle 10:</i> Summarization</b></button>
